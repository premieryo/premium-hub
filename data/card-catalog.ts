...
export const officialCardCatalog: CardCatalogProduct[] = [
  ...
  booster({ id: "world-strongest-warriors-op17-box", genre: "onepiece", name: "ONE PIECEカードゲーム ブースターパック「世界最強の戦士」[OP-17] BOX", searchWord: "世界最強の戦士 OP-17 BOX", releaseDate: "2026-08-22", seriesNumber: "OP-17", officialUrl: onePieceBoostersUrl, releaseStatus: "released" }),
  booster({ id: "onepiece-op16", genre: "onepiece", name: "ブースターパック 決戦の刻", searchWord: "決戦の刻 OP-16 BOX", releaseDate: "2026-05-30", seriesNumber: "OP-16", officialUrl: onePieceBoostersUrl, releaseStatus: "released" }),
  ...
  booster({ id: "onepiece-op14", genre: "onepiece", name: "ブースターパック 蒼海の七傑", searchWord: "蒼海の七傑 OP-14 BOX", releaseDate: "2025-11-22", seriesNumber: "OP-14", officialUrl: onePieceBoostersUrl, releaseStatus: "released" }),
  ...
  booster({ id: "onepiece-op13", genre: "onepiece", name: "ブースターパック 受け継がれる意志", searchWord: "受け継がれる意志 OP-13 BOX", releaseDate: "2025-08-23", seriesNumber: "OP-13", officialUrl: onePieceBoostersUrl, releaseStatus: "released" }),
  ...
  booster({ id: "story-booster-01-st01-box", genre: "dragonball", name: "ドラゴンボールスーパーカードゲーム フュージョンワールド STORY BOOSTER 01 [ST01] BOX", searchWord: "STORY BOOSTER 01 ST01 BOX", releaseDate: "2026-08-08", seriesNumber: "ST01", officialUrl: dragonBallBoostersUrl, releaseStatus: "released" }),
  booster({ id: "dragonball-fb10", genre: "dragonball", name: "ブースターパック CROSS FORCE", searchWord: "CROSS FORCE FB10 BOX", releaseDate: "2026-06-13", seriesNumber: "FB10", officialUrl: dragonBallBoostersUrl, releaseStatus: "released" }),
  booster({ id: "dragonball-fb09", genre: "dragonball", name: "ブースターパック DUAL EVOLUTION", searchWord: "DUAL EVOLUTION FB09 BOX", releaseDate: "2026-03-14", seriesNumber: "FB09", officialUrl: dragonBallBoostersUrl, releaseStatus: "released" }),
  booster({ id: "dragonball-fb08", genre: "dragonball", name: "ブースターパック 誇り高き戦闘民族", searchWord: "誇り高き戦闘民族 FB08 BOX", releaseDate: "2025-12-13", seriesNumber: "FB08", officialUrl: dragonBallBoostersUrl, releaseStatus: "released" }),
  booster({ id: "dragonball-sb02", genre: "dragonball", name: "MANGA BOOSTER 02", searchWord: "MANGA BOOSTER 02 SB02 BOX", releaseDate: "2025-11-08", seriesNumber: "SB02", officialUrl: dragonBallBoostersUrl, releaseStatus: "released" }),
  booster({ id: "dragonball-fb07", genre: "dragonball", name: "ブースターパック 神龍への願い", searchWord: "神龍への願い FB07 BOX", releaseDate: "2025-09-13", seriesNumber: "FB07", officialUrl: dragonBallBoostersUrl, releaseStatus: "released" }),
  ...
  booster({ id: "dragonball-fb06", genre: "dragonball", name: "ブースターパック 迫り来る脅威", searchWord: "迫り来る脅威 FB06 BOX", releaseDate: "2025-04-26", seriesNumber: "FB06", officialUrl: dragonBallBoostersUrl, releaseStatus: "released" }),
  booster({ id: "dragonball-fb05", genre: "dragonball", name: "ブースターパック 未知なる冒険", searchWord: "未知なる冒険 FB05 BOX", releaseDate: "2025-02-08", seriesNumber: "FB05", officialUrl: dragonBallBoostersUrl, releaseStatus: "released" }),
  booster({ id: "dragonball-fb04", genre: "dragonball", name: "ブースターパック 限界を超えし者", searchWord: "限界を超えし者 FB04 BOX", releaseDate: "2024-11-08", seriesNumber: "FB04", officialUrl: dragonBallBoostersUrl, releaseStatus: "released" }),
  booster({ id: "dragonball-fb03", genre: "dragonball", name: "ブースターパック 怒りの咆哮", searchWord: "怒りの咆哮 FB03 BOX", releaseDate: "2024-08-09", seriesNumber: "FB03", officialUrl: dragonBallBoostersUrl, releaseStatus: "released" }),
  booster({ id: "dragonball-fb02", genre: "dragonball", name: "ブースターパック 烈火の闘気", searchWord: "烈火の闘気 FB02 BOX", releaseDate: "2024-05-10", seriesNumber: "FB02", officialUrl: dragonBallBoostersUrl, releaseStatus: "released" }),
  booster({ id: "dragonball-fb01", genre: "dragonball", name: "ブースターパック 覚醒の鼓動", searchWord: "覚醒の鼓動 FB01 BOX", releaseDate: "2024-02-16", seriesNumber: "FB01", officialUrl: dragonBallBoostersUrl, releaseStatus: "released" }),
